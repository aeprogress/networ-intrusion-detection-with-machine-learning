...
class Flow:
    ...
    def get_data(self) -> dict:
        ...
        data = {
            ...
            "flow_bytes/s": flow_bytes.get_rate(),
            "flow_packets/s": packet_count.get_rate(),
            "fwd_packets/s": packet_count.get_rate(PacketDirection.FORWARD),
            "bwd_packets/s": packet_count.get_rate(PacketDirection.REVERSE),
            # Count total packets by direction
            "total_fwd_packets": packet_count.get_total(PacketDirection.FORWARD),
            "total_backward_packets": packet_count.get_total(PacketDirection.REVERSE),
            # Statistical info obtained from Packet lengths
            "total_length_of_fwd_packets": packet_length.get_total(PacketDirection.FORWARD),
            "total_length_of_bwd_packets": packet_length.get_total(PacketDirection.REVERSE),
            "fwd_packet_length_max": float(packet_length.get_max(PacketDirection.FORWARD)),
            "fwd_packet_length_min": float(packet_length.get_min(PacketDirection.FORWARD)),
            "fwd_packet_length_mean": float(packet_length.get_mean(PacketDirection.FORWARD)),
            "fwd_packet_length_std": float(packet_length.get_std(PacketDirection.FORWARD)),
            "bwd_packet_length_max": float(packet_length.get_max(PacketDirection.REVERSE)),
            "bwd_packet_length_min": float(packet_length.get_min(PacketDirection.REVERSE)),
            "bwd_packet_length_mean": float(packet_length.get_mean(PacketDirection.REVERSE)),
            "bwd_packet_length_std": float(packet_length.get_std(PacketDirection.REVERSE)),
            "max_packet_length": packet_length.get_max(),
            "min_packet_length": packet_length.get_min(),
            "packet_length_mean": float(packet_length.get_mean()),
            "packet_length_std": float(packet_length.get_std()),
            "packet_length_variance": float(packet_length.get_var()),
            "fwd_header_length": flow_bytes.get_forward_header_bytes(),
            "fwd_header_length.1": flow_bytes.get_forward_header_bytes(),
            "bwd_header_length": flow_bytes.get_reverse_header_bytes(),
            ...
            "fwd_iat_total": forward_iat["total"],
            ...
            "bwd_iat_total": float(backward_iat["total"]),
            ...
            "fin_flag_count": flag_count.has_flag("FIN"),
            "syn_flag_count": flag_count.has_flag("SYN"),
            "rst_flag_count": flag_count.has_flag("RST"),
            "psh_flag_count": flag_count.has_flag("PSH"),
            "ack_flag_count": flag_count.has_flag("ACK"),
            "urg_flag_count": flag_count.has_flag("URG"),
            "ece_flag_count": flag_count.has_flag("ECE"),
            # Response Time
            "down/up_ratio": packet_count.get_down_up_ratio(),
            "average_packet_size": packet_length.get_avg(),
        ...
        # Duplicated features
        data["avg_fwd_segment_size"] = data["fwd_packet_length_mean"]
        data["avg_bwd_segment_size"] = data["bwd_packet_length_mean"]
        # data["cwe_flag_count"] = data["fwd_urg_flags"]
        data["subflow_fwd_packets"] = data["total_fwd_packets"]
        data["subflow_bwd_packets"] = data["total_backward_packets"]
        data["subflow_fwd_bytes"] = data["total_length_of_fwd_packets"]
        data["subflow_bwd_bytes"] = data["total_length_of_bwd_packets"]
